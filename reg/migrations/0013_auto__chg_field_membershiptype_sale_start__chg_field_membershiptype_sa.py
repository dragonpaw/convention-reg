...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('reg_membershipsold', 'payment_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['reg.Payment']))
        # Adding field 'Event.end_date'
        db.add_column('reg_event', 'end_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 7, 2, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MembershipType.sale_start'
        raise RuntimeError("Cannot reverse this migration. 'MembershipType.sale_start' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'MembershipType.sale_end'
        raise RuntimeError("Cannot reverse this migration. 'MembershipType.sale_end' and its values cannot be restored.")

        # Changing field 'MembershipSold.payment'
        db.alter_column('reg_membershipsold', 'payment_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['reg.Payment']))
        # Deleting field 'Event.end_date'
        db.delete_column('reg_event', 'end_date')
    ...
    models = {
        ...
        'reg.membershiptype': {
            ...
            'sale_end': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'sale_start': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'})
        },
        'reg.payment': {

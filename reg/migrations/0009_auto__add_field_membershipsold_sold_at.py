...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('reg_membershipsold', 'sold_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2010, 4, 29, 20, 59, 32, 781122), blank=True), keep_default=False)

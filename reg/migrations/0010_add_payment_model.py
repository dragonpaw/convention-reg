...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('reg_payment', (
            ...
            ('ui_used', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('authcode', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('identifier', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('method', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reg.PaymentMethod'], null=True, blank=True)),
            ('transaction_id', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
        ))
        db.send_create_signal('reg', ['Payment'])

        # Adding field 'MembershipSold.payment'
        db.add_column('reg_membershipsold', 'payment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reg.Payment'], null=True, blank=True), keep_default=False)

        # Adding field 'PaymentMethod.gateway'
        db.add_column('reg_paymentmethod', 'gateway', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MembershipSold.payment'
        db.delete_column('reg_membershipsold', 'payment_id')

        # Deleting field 'PaymentMethod.gateway'
        db.delete_column('reg_paymentmethod', 'gateway')

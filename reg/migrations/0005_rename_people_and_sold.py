...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('reg_member', 'reg_person')
        db.rename_table('reg_membership', 'reg_membershipsold')

    def backwards(self, orm):
        db.rename_table('reg_person', 'reg_member')
        db.rename_table('reg_membershipsold', 'reg_membership')
    ...
    models = {
        ...
        'reg.membershipsold': {
            'Meta': {'unique_together': "(('member', 'type'),)", 'object_name': 'MembershipSold'},
